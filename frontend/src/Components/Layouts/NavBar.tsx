...
const NavBar = () => {
  ...
  return (
    <header className={`text-gray-600 body-font ${ChangeColor?'fixed top-0 z-20':'fixed'} sm:fixed top-0 w-full z-10`}>
    <div className="container  sm:justify-between  mx-auto flex flex-wrap p-5 flex-col sm:flex-row  items-center">
      <a href='/' className="flex title-font font-medium items-center text-gray-900 mb-4 sm:mb-0">
      ...
      <nav className={`md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center  sm:text-[14px] md:text-base justify-center ${ChangeColor?'text-pink-600 font-bold':'text-pink-300'} `}>
        <a href='/' className="mr-3 md:mr-5 hover:text-pink-500">First Link</a>
        <a href='/' className="mr-3 md:mr-5 hover:text-pink-500">Second Link</a>
        <a href='/' className="mr-3 md:mr-5 hover:text-pink-500">Third Link</a>
